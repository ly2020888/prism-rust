...
pub struct Cli {
    ...
    #[arg(short,long,default_value_t = String::from("/tmp/prism-blocks.rocksdb"))]
    pub block_db: String,

    /// Sets the path to the balance database
    #[arg(short,long,default_value_t = String::from("/tmp/prism-balancedb.rocksdb"))]
    pub balancedb: String,

    /// Sets the path to the blockchain database
    #[arg(short,long,default_value_t = String::from("/tmp/prism-blockchain_db.rocksdb"))]
